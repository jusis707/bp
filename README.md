...
21. Check if app is running and serving web content "Hello BP!" and mounted well at /mnt via ansible-playbook (in my case bp-myproject.127.0.0.1.nip.io and bp-2-hh8mc)
# file bp1.yaml
